...
Drycc Workflow currently supports:
  ...
  1. off-cluster: Any provider that supports long-lived username/password authentication, such as [Azure Container Registry][acr], [Docker Hub][dockerhub], [quay.io][quay], or a self-hosted container registry.
