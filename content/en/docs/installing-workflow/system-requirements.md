...
Drycc uses gateway as a routing implementation, so you have to choose a gateway. We recommend using [istio](https://istio.io/) or [kong](https://konghq.com/).
...
Workflow supports Amazon Simple Storage Service (S3), Google Cloud Storage (GCS), OpenShift Swift, and Azure Blob Storage. See [configuring object storage](configuring-object-storage) for setup instructions.
