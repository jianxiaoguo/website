...
description: Learn how to create, bind, and manage external resources and services for Drycc applications using the service catalog.
weight: 10
---

You can use the commands below to create resources and bind them to applications. These commands depend on the [service-catalog](https://service-catalog.drycc.cc).
